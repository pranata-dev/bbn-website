...
const w5 = parseTxtFile('C:/Users/p/OneDrive/Dokumen/WEEK 5 QUESTION FIXXX.txt', 'WEEK_5');

// Write as JSON for record
fs.writeFileSync('C:/Users/p/.gemini/antigravity/scratch/bbn-website/scripts/data/week5_parsed.json', JSON.stringify(w5, null, 2));

// Write as TS for seeding script compatibility
const tsContent = `export const week5Questions = ${JSON.stringify(w5, null, 4)};\n`;
fs.writeFileSync('C:/Users/p/.gemini/antigravity/scratch/bbn-website/scripts/data/week5.ts', tsContent);

console.log(`Parsed ${w5.length} questions for week 5`);
