...
const w2Path = "C:\\\\Users\\\\p\\\\OneDrive\\\\Dokumen\\\\WEEK 2 QUESTION.txt";
const w3Path = "C:\\\\Users\\\\p\\\\OneDrive\\\\Dokumen\\\\WEEK 3 QUESTION.txt";

const w2q = parseQuestions(w2Path, 'WEEK_2');
const w3q = parseQuestions(w3Path, 'WEEK_3');

writeTsFile(w2q, path.resolve('src', 'lib', 'data', 'week2.ts'), 'week2Questions');
writeTsFile(w3q, path.resolve('src', 'lib', 'data', 'week3.ts'), 'week3Questions');
console.log('Done parsing W2 and W3');
