...
import { week2Questions } from '../src/lib/data/week2';
import { week3Questions } from '../src/lib/data/week3';
...
async function run() {
    await seedWeek('WEEK 2', 'WEEK_2', week2Questions);
    await seedWeek('WEEK 3', 'WEEK_3', week3Questions);
    console.log('\n✅ ALL DONE');
}
