        ...
        return (
            <div className="flex items-center justify-center min-h-[60vh] font-mono">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-[#2b1b11] font-bold text-sm">Memulai latihan soal...</p>
                </div>
            </div>
        )
    }
            ...
            <div className="bg-[#FEFCF3] border-4 border-[#2b1b11] shadow-[4px_4px_0px_#2b1b11] select-none" onContextMenu={(e) => e.preventDefault()}>
                ...
                <div className="p-6">
                    ...
                    {currentQuestion.option_a !== "-" ? (
                        ...
                        <div className="space-y-3">
                            <label className="text-xs font-bold text-[#3c5443] uppercase tracking-wider">Jawaban Singkat</label>
                            <textarea
                                value={answers[currentQuestion.id]?.answer || ""}
                                onChange={(e) => handleAnswer(currentQuestion.id, e.target.value)}
                                placeholder="Tulis jawabanmu di sini..."
                                rows={3}
                                className="w-full p-4 border-4 border-[#2b1b11] focus:border-[#e87a5d] outline-none text-sm font-bold resize-none transition-all bg-[#FEFCF3] shadow-[2px_2px_0px_#2b1b11] text-[#2b1b11]"
                            />
                        </div>
                    )}
                </div>
